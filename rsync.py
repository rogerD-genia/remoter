...
_default_rsync_bin_path = '/usr/bin/rsync'
_default_rsync_options = ('-crlptv --exclude=/build*/ --exclude=/bin/ '
                          '--exclude=.DS_Store --exclude=*.pyc --exclude=*.so '
                          '--exclude=*.egg-info --include=.git --del')
